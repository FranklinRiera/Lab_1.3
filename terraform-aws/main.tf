...
resource "aws_key_pair" "my_key_pair" {
  key_name   = "aws"
  public_key = file("/home/frankcoriera/aws.pub")  # Adjust the path to your public key file
}

provider "aws" {
  region = "us-east-1" # Cambia esto a la región de AWS que prefieras
  access_key = "AKIA4LK7EUCEOVYHSTRG"
	secret_key = "7FiiL432Li10tixXFTXjDglTE4yhDQpoj5z3rmK5"
}
